        ...
        <div class="col-lg-6 col-md-6">
            <div class="well with-header with-footer">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-6">
                        <a href="{{ route('admin.bidang_keahlian.create') }}" class="btn btn-success btn-sm">
                            Tambah
                        </a>
                    </div>
                    <div class="col-md-6" style="display:flex; justify-content: flex-end">
                        <form action="{{ route('admin.bidang_keahlian') }}" style="display: flex" method="GET">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->nama }}</td>
                            <td>
                                <a href="{{ route('admin.bidang_keahlian.edit', $item->id) }}">
                                    <button class="btn btn-warning btn-sm">Ubah</button>
                                </a>
                                <form onsubmit="deleteThis(event)" action="{{ route('admin.bidang_keahlian.delete') }}" method="POST" style="display:inline-block">
                ...
                <div class="footer">
                    {{ $bidang_keahlian->appends(['q_nama' => $q_nama])->links() }}
                </div>
            </div>
