        ...
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <div class="collapse in">
                    <form role="form" action="{{ route('admin.unit_kerja.update') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" value="{{ old('type', $unit_kerja->nama) }}" class="form-control input-sm" id="nama">
                        </div>
